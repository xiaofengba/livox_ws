...
LastEditTime: 2025-11-11 11:19:20
FilePath: /livox_ws/src/livox_repub_ros2/scripts/imu_reput.py
...
class ImuProcessor(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(
            Imu, 
            '/livox/imu/processed',  # 输出话题
            10)
        
        self.get_logger().info(f'IMU处理器已启动，重力缩放系数: {self.g}')
        self.get_logger().info('订阅: /imu/data_raw, 发布: /livox/imu/processed')
