...
class ImuProcessor(Node):
    ...
    def imu_callback(self, msg):
        ...
        try:
            ...
            processed_msg.header.frame_id = "rslidar"  # 明确设置frame_id
            
            # 复制原始数据
            processed_msg.orientation = msg.orientation
            
            # 设置方向协方差矩阵
            processed_msg.orientation_covariance = [0.05, 0.0, 0.0,
                                                0.0, 0.05, 0.0,
                                                0.0, 0.0, 0.05]
            ...
            # 设置角速度协方差矩阵
            processed_msg.angular_velocity_covariance = [0.05, 0.0, 0.0,
                                                        0.0, 0.05, 0.0,
                                                        0.0, 0.0, 0.05]
            ...
            # 设置线性加速度协方差矩阵
            processed_msg.linear_acceleration_covariance = [0.05, 0.0, 0.0,
                                                        0.0, 0.05, 0.0,
                                                        0.0, 0.0, 0.05]
